...
- [PROJECT_PLAN.md](./PROJECT_PLAN.md) - Spec, design, tasks
...
- [redesign/DESIGN_REVAMP_PLAN.md](./redesign/DESIGN_REVAMP_PLAN.md)
- [redesign/IMPLEMENTATION_PLAN.md](./redesign/IMPLEMENTATION_PLAN.md)

## DevOps

- [devops/SECURITY.md](./devops/SECURITY.md)
...
- [SYNC_TROUBLESHOOTING.md](./SYNC_TROUBLESHOOTING.md)

## Decisions (ADRs)

- [001 - Supabase Local Development](./decisions/001-supabase-local-development.md)
...
- [working-memory/](./working-memory/) - Active task tracking
